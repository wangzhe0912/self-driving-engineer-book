...
在本书中，我们将使用python和**opencv**进行计算机视觉相关的工作。**opencv**的全称是Open-Source Computer Vision。它包含了大量可以使用的函数库。OpenCV库有很好的文档记录，因此如果您对特定函数中的参数在做什么或其他事情感到困惑，可以在opencv.org上找到大量信息。
