...
在本书中，我们将使用python和**opencv**进行计算机视觉相关的工作。**opencv**的全称是Open-Source Computer Vision。现在，您不需要下载或安装任何东西，但稍后在程序中，我们将帮助您在自己的计算机上安装这些工具。

opencv包含了大量可以使用的函数库。OpenCV库有很好的文档记录，因此如果您对特定函数中的参数在做什么或其他事情感到困惑，可以在opencv.org上找到大量信息。
