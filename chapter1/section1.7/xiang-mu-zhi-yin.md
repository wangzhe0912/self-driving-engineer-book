...
一旦您对弯曲空间中的线位置进行了很好的测量，就可以将测量结果投射到路面上了！让我们假设，就像前面的例子中一样，你有一个扭曲的二进制图像叫做warped，你用线条拟合多项式，并且有一个名为ploty，left_fitx和right_fitx的数组，它们代表线条的x和y像素值。然后，您可以将这些线投影到原始图像上，如下所示：
